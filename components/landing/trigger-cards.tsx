...
const TRIGGERS = [
  {
    ...
    description:
      '갑작스러운 비에 택시를 잡거나, 의도치 않게 옷이 더러워져 세탁비가 늘거나, 외출 일정을 취소하게 됩니다. 우산을 챙기는 걸 깜빡했다면 편의점에서 또 소비하게 되죠.',
  },
  {
    key: 'heat',
    title: '폭염',
    ...
    description:
      '33℃를 넘는 날은 밖에 나가는 것 자체가 고역입니다. 불쾌지수가 치솟고 열대야까지 이어지면 잠들기도 힘들죠. 컨디션이 무너지면 계획했던 루틴이 하나씩 밀리기 시작합니다.',
  },
  {
    key: 'snow',
    title: '눈',
    ...
    description:
      '도로가 막히고 대중교통이 지연되고, 조심한다고 해도 미끄러운 길은 긴장을 놓을 수 없게 합니다. 약속 시간을 맞추느라 허둥대고, 집에 돌아오면 신발과 옷이 엉망이 되어 있죠.',
  },
  {
    key: 'cold',
    title: '한파',
    ...
    description:
      '너무 추워서 버스 정류장에 서 있는 것조차 힘든 날입니다. 패딩을 입어도 바람이 파고들고, 난방을 세게 틀면 요금 걱정이 따라옵니다. 그냥 집에만 있자니 하루가 통째로 사라지는 기분이죠.',
  },
  {
    key: 'dust',
    title: '미세먼지',
    ...
    description:
      '창문을 열 수도, 밖에 나갈 수도 없는 날입니다. 마스크를 써도 목이 칼칼하고, 공기청정기만 하루 종일 돌리게 됩니다. 그냥 버티자니 하루가 통째로 답답해지는 기분이죠.',
  },
] as const
    ...
    <FadeUp className="pt-16 pb-10 md:pt-24 md:pb-14">
      <div className="mx-auto max-w-7xl px-6 md:px-12">
        ...
        <p className="mt-4 text-base text-muted-foreground md:text-lg">
          기상청 공식 API가 조건을 자동으로 감지합니다. 신청 없이 자동 지급됩니다.
        </p>
      </div>
